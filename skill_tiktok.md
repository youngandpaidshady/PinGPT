---
name: PinGPT TikTok Slideshow Mode
description: Generate 10-slide TikTok carousel prompts with narrative tension pacing — v5 Viral
---
...
> **CRITICAL ENGINE OVERRIDE**: This mode inherits ALL rules from the main PinGPT Prompt Engine (v5.1 Viral — Strict Mod). **ABSOLUTELY NO TEXT/KANJI** and **NO FLAT/PASSIVE POSES** are permitted in any slide. Characters MUST interact physically with their environment. Read the main `skill.md` first.
...
|-------|---------|----------------|
| 1 | **HOOK** — stop the scroll | Most dramatic image: intense close-up framing (upper chest up), peak emotion, extreme lighting contrast. Must have a **scroll-stop element** (bright-against-dark, neon splash, glowing eyes) |
| 2 | **CONTEXT** — establish character | Full-body wide shot, environment reveal, character recognition. Use **foreground depth layering** here |
...
5. **Max 80 words per slide prompt** — same cap as main engine. Ruthlessly cut weak adjectives
6. **⛔ STRICT BAN ON FLAT POSES**: Absolutely NO passive "standing" poses anywhere. Characters must lean their weight, crouch, sit, or grasp a prop. 
7. **⛔ STRICT BAN ON TEXT**: Absolutely NO text overlays, no kanji, no typography. The only permitted text is a subtle series marker "I/10" on slide 10 if necessary.
8. **Warm balance**: At least 3 of 10 slides must use warm palettes (Golden Amber, Warm Sepia, Sakura Pink)
9. **Emotional tension in at least 3 of 10 slides** — place the character in moments contradicting their canon persona
...
[Complete prompt text — max 80 words]
